...
// Se puede observar una mejora muy significativa con la implementacion C) es menor a 1seg mientras que con la implementacion A)
// tarda varios segundos 15seg aprox.
