...
DEFAULT_DIR = 'testdata' #Colocado por los profes
#DEFAULT_DIR = '.'  # '.' representa el directorio actual
#Solucion temporal hasta saber el directorio al que acceder si un testdata creado por nosotros o el actual
DEFAULT_ADDR = '0.0.0.0'  # 0.0.0.0 representa todas las IPv4 del server
#DEFAULT_ADDR = '127.0.0.1'  # 127.0.0.1 es la direccion que apunta a la maquina local para pruebas cerradas en la misma maquina
DEFAULT_PORT = 19500
